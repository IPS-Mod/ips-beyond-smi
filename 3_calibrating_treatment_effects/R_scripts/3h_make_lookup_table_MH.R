...
ggsave("3_calibrating_treatment_effects/output/MH_multiplier_v_empl.png")
...
data_out %>%
  ...
  annotate("text", x = 0.5, y = EmpAt12mthBAU + 0.03, color = "#aacc00", size = 3, 
           label = paste0("LFS = ",round(EmpAt12mthBAU*100,2),"%")) 
ggsave("3_calibrating_treatment_effects/output/MH_calib_v_empl.png")
...
data_out %>%
  ...
  labs(x = "Multiplier",
       ...
       color = "Calibration") +
  scale_color_manual(values = c("#ff4000","#4f000b","#720026","#ce4257"))
ggsave("3_calibrating_treatment_effects/output/MH_calib_v_multiplier.png")
...
saveRDS(lkup_table,"3_calibrating_treatment_effects/intermediate_data/performance_multipliers_mh.rds")
