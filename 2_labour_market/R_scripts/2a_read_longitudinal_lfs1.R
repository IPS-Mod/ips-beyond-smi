...
input_data <- c("five_q_longitudinal_jm15-jm16_eul_lgwt17.tab", # data4
                "five_q_longitudinal_aj15-aj16_eul_lgwt17.tab", # data5
                "five_q_longitudinal_js15-js16_eul_lgwt17.tab", # data6 (no data on health condition)
                "five_q_longitudinal_od15-od16_eul_lgwt17.tab", # data7
                "five_q_longitudinal_jm16-jm17_eul_lgwt17.tab", # data8
                "5q_longitudinal_aj16-aj17_eul_lgwt17.tab", # data9
                "5q_longitudinal_js16-js17_eul_lgwt17.tab", # data10
                "5q_longitudinal_od16-od17_eul_lgwt17.tab", # data11
                "fiveq_longitudinal_jm17-jm18_eul_lgwt17.tab", # data12
                "five_q_longitudinal_aj17-aj18_eul_lgwt17.tab", # data13
                "five_q_longitudinal_js17-js18_eul_lgwt17.tab", # data14
                "five_q_longitudinal_od17-od18_eul_lgwt17.tab", # data15
                "five_q_jm18_jm19_eul_lgwt17.tab",
                "lgwt18_5q_aj18_aj19_eul.tab", # data17 
                "lgwt18_5q_js18_js19_eul.tab",
                "lgwt18_5q_od18_od19_eul.tab") # data16
...
data4 <- data.table::fread(input = input, na.strings = c("-9","-8")) 
  ...
  if (i %in% 14:16){
    names(data4) <- toupper(names(data4))
    data4 <- data4 %>% rename_at('LGWT18', ~'LGWT')
  }
  
if (i != 3){
data4 <- data4 %>% select(PERSID, LGWT, CONMPY1, WEEK, 
         INCAC051, CONMON1, AGE1, SCHM121, OOBEN1, GRSSWK1, TTUSHR1, WNEFT111, HEAL011, HEAL021, HEAL031,
         INCAC052, CONMON2, AGE2, SCHM122, OOBEN2, GRSSWK2, TTUSHR2, WNEFT112, HEAL012, HEAL022, HEAL032, 
         INCAC053, CONMON3, AGE3, SCHM123, OOBEN3, GRSSWK3, TTUSHR3, WNEFT113, HEAL013, HEAL023, HEAL033,
         INCAC054, CONMON4, AGE4, SCHM124, OOBEN4, GRSSWK4, TTUSHR4, WNEFT114, HEAL014, HEAL024, HEAL034,
         INCAC055, CONMON5, AGE5, SCHM125, OOBEN5, GRSSWK5, TTUSHR5, WNEFT115, HEAL015, HEAL025, HEAL035)  
} else {
data4 <- data4 %>% select(PERSID, LGWT, CONMPY1, WEEK, 
                          INCAC051, CONMON1, AGE1, SCHM121, OOBEN1, GRSSWK1, TTUSHR1, WNEFT111, 
...
data4 <- subset(data4, select = -c(INCAC051, OOBEN1))
...
data4 <- subset(data4, select = -c(INCAC052, OOBEN2))
...
data4 <- subset(data4, select = -c(INCAC053, OOBEN3))
...
data4 <- subset(data4, select = -c(INCAC054, OOBEN4))
...
data4 <- subset(data4, select = -c(INCAC055, OOBEN5))
...
data4 <- data4 %>% select(PERSID, LGWT, CONMPY1, WNEFT111, 
                          AGE1, SCHM121, Empl1, CONMON1, MONTHw1, Unempbenefits1, Sickbenefits1, Inactbenefits1, Otherbenefits1, nobenefits1, TTUSHR1, GRSSWK1, everworkedw1, MSK1, MH1, MSK_MH1, 
                          AGE2, SCHM122, Empl2, CONMON2, MONTHw2, Unempbenefits2, Sickbenefits2, Inactbenefits2, Otherbenefits2, nobenefits2, TTUSHR2, GRSSWK2, everworkedw2, MSK2, MH2, MSK_MH2, 
                          AGE3, SCHM123, Empl3, CONMON3, MONTHw3, Unempbenefits3, Sickbenefits3, Inactbenefits3, Otherbenefits3, nobenefits3, TTUSHR3, GRSSWK3, everworkedw3, MSK3, MH3, MSK_MH3,
                          AGE4, SCHM124, Empl4, CONMON4, MONTHw4, Unempbenefits4, Sickbenefits4, Inactbenefits4, Otherbenefits4, nobenefits4, TTUSHR4, GRSSWK4, everworkedw4, MSK4, MH4, MSK_MH4,
                          AGE5, SCHM125, Empl5, CONMON5, MONTHw5, Unempbenefits5, Sickbenefits5, Inactbenefits5, Otherbenefits5, nobenefits5, TTUSHR5, GRSSWK5, everworkedw5, MSK5, MH5, MSK_MH5)
} else {
  data4 <- data4 %>% select(PERSID, LGWT, CONMPY1, WNEFT111, 
...
if (i == 1){
  final_data_1 <- copy(data4)
} else {
  final_data_1 <- rbindlist(list(final_data_1, data4), fill = TRUE)
}
